...
// Campos de la informacion del cliente
...
// Componente ///////////////////////////////////////////////////////////
const VentanaEmergenteDetallesCliente = ({
	estado,
	cambiarEstado,
	clienteDetalles,
  camposProductos
  ...
  const {DIRECCION, PRODUCTOS_PRECIOS, ID, ...informacionCliente} = clienteDetalles;
		...
		<>
			{estado && (
				<Overlay>
					<ContenedorVentana>
						<TituloOperacion>
							<h3>{informacionCliente.NOMBRE}</h3>
						</TituloOperacion>
            <Resumenes>
            <Resumen
              key = {'Informacion'}
...
export default VentanaEmergenteDetallesCliente;

...
import TicketRuta from '../componentes/TicketRuta'
...
function ImprimirTicket ({estado, cambiarEstado, datosSalidaRuta, reset}) {
          ...
          <ContenedorVentana>
            ...
            <ReactToPrint 
              ...
              <div style = {{display: 'none'}}>
                <TicketRuta ref={componentRef} datosSalidaRuta = {datosSalidaRuta}/>
              </div>
          </ContenedorVentana>
        </Overlay>
      }
